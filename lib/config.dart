class Config {
  ...
  static const rolesDescription = {
    ...
    'MAF': 'You are Mafia. Mafia find out each other’s identity in the first nighttime phase. While the other players are attempting to figure out who they are, the mafia must lie throughout the entire game and act as though they are civilians. At night, when the mafia awaken, they point silently to the player they’d like to kill.',
